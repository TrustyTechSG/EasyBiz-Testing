...
expect(page.getByText('Customer name test')).toBeAttached();
expect(page.getByText('Customer tel +91 98765 53210')).toBeAttached();
expect(page.getByText('Return type Self collection at FIRST STORE')).toBeAttached();
expect(page.getByText('Sweater x 1/pcs')).toBeAttached();
expect(page.getByText('- Laundry')).toBeAttached();
expect(page.getByText('Subtotal 1/unit')).toBeAttached();
expect(page.getByText('Difference to minimum (min: ₹ 10.00)')).toBeAttached();
});