...
await expect(page.getByRole('tabpanel', { name: 'Customer receipt' }).getByText('Subtotal 2/pcs ₹ 20.00')).toBeVisible();
await expect(page.getByRole('tabpanel', { name: 'Customer receipt' }).getByText('GST 2% ₹ 0.39')).toBeVisible();
await expect(page.getByRole('tabpanel', { name: 'Customer receipt' }).getByText('Rounding ₹ 0.01')).toBeVisible();
await expect(page.getByRole('tabpanel', { name: 'Customer receipt' }).getByText('Total (inclusive of GST) ₹ 20.00')).toBeVisible();
await expect(page.getByRole('tabpanel', { name: 'Customer receipt' }).getByText('Pay by Cash (₹ 20.00)')).toBeVisible();
