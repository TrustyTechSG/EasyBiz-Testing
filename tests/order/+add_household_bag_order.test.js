...
test('test', async ({ page }) => {
  ...
  await page.getByText('bag').click();
  await page.getByRole('button', { name: '1 bag = ?pcs' }).click();
  ...
  await expect(page.getByText('Mattress Protector ₹ 11.00 x 1/bag ₹ 11.00')).toBeVisible();
