...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: '1 set = 1pcs' }).click();
  await page.getByRole('button', { name: '2', exact: true }).click();
  await page.getByRole('button', { name: 'Update' }).click();
  await page.locator('label').filter({ hasText: 'Laundry' }).click();
  ...
  await expect(page.getByText('Mattress Protector ₹ 18.00 x 1/set ₹ 18.00')).toBeVisible();
