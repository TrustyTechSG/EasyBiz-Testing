...
await page.getByText('Stuffed Toy').click();
await page.getByText('3 - 7 inches').click();
...
await expect(page.getByText('Stuffed Toy - 3 - 7 ₹ 14.00 x 1/pcs ₹ 14.00 inches')).toBeVisible();
await expect(page.getByText('Total (inclusive of GST) ₹ 14.00')).toBeVisible();
await expect(page.getByText('Pay by Cash (₹ 14.00)')).toBeVisible();
});
