...
await expect(page.getByText('Item total: ₹150.00')).toBeVisible();
await expect(page.getByText('#1 Bag₹150.00x1 ₹150.00')).toBeVisible();
await expect(page.getByText('Deep Cleaning').nth(1)).toBeVisible();
