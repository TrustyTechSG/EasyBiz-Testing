...
await expect(page.getByText('anniversary offer(2% off)EnabledDisabled₹0.24PromotionMin. ₹5.00')).toBeVisible();
await page.getByRole('button', { name: 'Payment' }).click();
await page.getByRole('button', { name: 'cash' }).click();
await expect(page.getByText('Payable Amount₹12.00')).toBeVisible();
