...
expect(page.getByText('Customer name: test')).toContain;
expect(page.getByText('Customer tel: +91 98765 53210')).toContain;
expect(page.getByText('Leather Jacket ₹ 60.00 x 1/pcs ₹ 60.00')).toContain;
expect(page.getByText('- Dry Clean')).toContain;
expect(page.getByText('Return type: Home delivery')).toContain;
expect(page.getByText('Subtotal 1/pcs ₹ 60.00')).toContain;
expect(page.getByText('Total (inclusive of GST) ₹ 60.00')).toContain;
expect(page.getByText('Address: Thanjavur, Tamil Nadu 613006, India')).toBeTruthy();// edit address
