...
test('test', async ({ page }) => {
  ...
  const currentMonth = currentDate.getMonth() + 1; // Add 1 to current month to get the next month
  ...
  await expect(page.getByText(`- Estimated completion: ${expectedCompletionDate} (Su)`)).toBeVisible();
