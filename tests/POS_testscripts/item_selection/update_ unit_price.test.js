...
expect(page.getByRole('button', { name: '₹9.00' })).toBeVisible();
expect(page.getByText('#1 T-Shirt₹9.00x1 pcs₹9.00Laundry')).toBeVisible();
...
await expect(page.getByText('T-Shirt ₹ 9.00 x 1/pcs ₹ 9.00')).toBeVisible();
