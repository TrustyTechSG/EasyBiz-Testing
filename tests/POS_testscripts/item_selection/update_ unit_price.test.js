...
expect(page.getByRole('button', { name: '₹9.00' })).toBeAttached();
expect(page.getByText('#1 T-Shirt₹9.00x1 pcs₹9.00Laundry')).toBeAttached();
...
expect(page.getByText('T-Shirt ₹ 9.00 x 1/pcs ₹ 9.00')).toBeAttached();
