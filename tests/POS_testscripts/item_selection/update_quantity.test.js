...
expect(page.getByText('#1 T-Shirt₹6.00x2 pcs₹12.00')).toBeTruthy();
expect(page.getByText('Subtotal2 units₹12.00')).toBeTruthy();
await page.getByRole('button', { name: 'Payment' }).click();
await page.getByRole('button', { name: 'cash' }).click();
await page.getByRole('button', { name: 'Create order' }).click();
expect(page.getByText('T-Shirt ₹ 6.00 x 2/pcs ₹ 12.00')).toBeTruthy();
expect(page.getByText('- L')).toBeTruthy();
expect(page.getByText('Subtotal 2/pcs ₹ 12.00')).toBeTruthy();
