...
test('test', async ({ page }) => {
  ...
  await expect(page.getByText('Customer name: Cba')).toBeAttached();
  await expect(page.getByText('Customer tel: +91 94444 44444')).toBeAttached();
  await expect(page.getByText('Sweater ₹ 6.00 x 1/pcs ₹ 6.00')).toBeAttached();
})